...
public class Library {
    private static final String LIBRARY_NAME = "libgeomag-jni.dylib";
    ...
    private static String getLibraryFile() {
        String sacJniLibraryPath = System.getenv("GEOMAG_JNI_LIBRARY_PATH");
        ...
        File libsDir;
        try {
            Path tempDir = Files.createTempDirectory("geomag-jni");
